...
//	}
	...
	public static void invisibilityOfElement(WebDriver driver, By by) {
		//wait until element like (spinner/overlay) disappear that coming over /on top of needed element
	(new WebDriverWait(driver, 60, 10)).until(ExpectedConditions.invisibilityOfElementLocated(by));
	}
